...
<div class="article">
  <div class="article_container">
    ...
    <div class="article_img_wrap article_<?php echo $data['classWrap'][$j]?>">
      ...
      <img src="../objects/objects_<?php echo $data['section'][$j];?>/images/<?php echo $data['img'][$j][$i];?>" class="art_img <?php echo $data['classImg'][$j][$i+1]; ?>">
      <?php endfor; ?>
    </div>
    <?php endif; ?>
    <form method="POST" action="../manipulation">
      <div class="article_main_content">
        ...
        <h3 class="art_elem_file art_elem_main">
          ...
          <a href="../objects/objects_<?php echo $data['section'][$j];?>/materials/<?php echo $data["files"][$j][$f]?>"><!--!!!!!!!!!!!!!!!!!!!!!!-->
...
<div class="modal_display_delete">
  Delete this article?<?php echo $data['id'][$j]?>
  <form method="POST" action="../manipulation" class="del_form">
